...
# Form implementation generated from reading ui file 'FlightPlannerBase.ui'
#
# Created: Wed Apr 22 16:39:54 2015
...
class Ui_FlightPlannerBase(object):
    def setupUi(self, FlightPlannerBase):
        FlightPlannerBase.setObjectName(_fromUtf8("FlightPlannerBase"))
#         FlightPlannerBase.resize(678, 663)
        self.horizontalLayout = QtGui.QHBoxLayout(FlightPlannerBase)
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.tabCtrlGeneral = QtGui.QTabWidget(FlightPlannerBase)
        font = QtGui.QFont()
        ...
        self.tab_General = QtGui.QWidget(FlightPlannerBase)
        ...
        self.scrollArea = QtGui.QScrollArea(self.grbGeneral)
        self.scrollArea.setObjectName(_fromUtf8("scrollArea"))
        
        self.scrollArea.setWidgetResizable(True);

        self.scrollAreaWidgetContents = QtGui.QWidget(FlightPlannerBase);
        self.scrollAreaWidgetContents.setObjectName(_fromUtf8("scrollAreaWidgetContents"));
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 417, 479));
        self.vlScrollWidget = QtGui.QVBoxLayout(self.scrollAreaWidgetContents);
        self.vlScrollWidget.setObjectName(_fromUtf8("verticalLayout_ScrollWidget"));
        ...
        self.vlGeneral.addWidget(self.scrollArea)
        ...
        self.tab_Results = QtGui.QWidget(FlightPlannerBase)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("Resource/mActionZoomFullExtent.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.frm_cmbObstSurface = QtGui.QFrame(self.grbObstacles)
        self.frm_cmbObstSurface.setFrameShape(QtGui.QFrame.NoFrame)
        self.frm_cmbObstSurface.setFrameShadow(QtGui.QFrame.Raised)
        self.frm_cmbObstSurface.setObjectName(_fromUtf8("frm_cmbObstSurface"))
        self.horizontalLayout_102 = QtGui.QHBoxLayout(self.frm_cmbObstSurface)
        ...
        self.label_123 = QtGui.QLabel(self.frm_cmbObstSurface)
        ...
        self.cmbObstSurface = QtGui.QComboBox(self.frm_cmbObstSurface)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.vlObstacles.addWidget(self.frm_cmbObstSurface)
        self.tblObstacles = TableViewObstacle(self.grbObstacles)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Arial"))
...
#         self.frmResultButtons.setMinimumSize(QtCore.QSize(105, 16777215))
        ...
        self.btnExportResult = QtGui.QPushButton(self.frmResultButtons)
        font = QtGui.QFont()
        font.setWeight(50)
        font.setBold(False)
        ...
        self.vlResultBtns.addWidget(self.btnExportResult)
        ...
        btnStyle = QtGui.QStyleFactory.create("Cleanlooks")
        self.btnClose.setStyle(btnStyle)
        self.btnClose_2.setStyle(btnStyle)
        self.btnConstruct.setStyle(btnStyle)
        self.btnEvaluate.setStyle(btnStyle)
        self.btnLocate.setStyle(btnStyle)
        self.btnExportResult.setStyle(btnStyle)
        self.btnOpenData.setStyle(btnStyle)
        self.btnSaveData.setStyle(btnStyle)
        self.btnPDTCheck.setStyle(btnStyle)
        self.btnUpdateQA.setStyle(btnStyle)
        self.btnUpdateQA_2.setStyle(btnStyle)

        # style = QtGui.QStyleFactory.create("windows")
        # FlightPlannerBase.setStyle(style)
        # FlightPlannerBase.setStyleSheet("QLineEdit { background-color: yellow }")
        # FlightPlannerBase.setStyleSheet("QComboBox { background-color: red }")
        ...
        self.btnPDTCheck.setToolTip(_fromUtf8("PD Check"))
        self.btnUpdateQA.setToolTip(_fromUtf8("Update QA"))
        self.btnUpdateQA_2.setToolTip(_fromUtf8("Update QA"))
        ...
        self.btnUpdateQA_2.setIconSize(QtCore.QSize(32,32))

        # self.btnClose.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));
        # self.btnClose_2.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));
        # self.btnConstruct.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));
        # self.btnEvaluate.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));
        # self.btnLocate.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));
        # self.btnExportResult.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));
        # self.btnOpenData.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));
        # self.btnSaveData.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));
        # self.btnPDTCheck.setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 255);"));

        # btnClose_2->setStyleSheet(_fromUtf8("background-color: rgba(255, 255, 255, 0);"));

        # self.btnClose.setMaximumWidth(32)
        # self.btnClose_2.setMaximumWidth(32)
        # self.btnConstruct.setMaximumWidth(32)
        # self.btnEvaluate.setMaximumWidth(32)
        # self.btnLocate.setMaximumWidth(32)
        # self.btnExportResult.setMaximumWidth(32)
        # self.btnOpenData.setMaximumWidth(32)
        # self.btnSaveData.setMaximumWidth(32)
        # self.btnPDTCheck.setMaximumWidth(32)
        #
        # self.btnClose.setMinimumWidth(32)
        # self.btnClose_2.setMinimumWidth(32)
        # self.btnConstruct.setMinimumWidth(32)
        # self.btnEvaluate.setMinimumWidth(32)
        # self.btnLocate.setMinimumWidth(32)
        # self.btnExportResult.setMinimumWidth(32)
        # self.btnOpenData.setMinimumWidth(32)
        # self.btnSaveData.setMinimumWidth(32)
        # self.btnPDTCheck.setMinimumWidth(32)
        #
        # self.btnClose.setMaximumHeight(32)
        # self.btnClose_2.setMaximumHeight(32)
        # self.btnConstruct.setMaximumHeight(32)
        # self.btnEvaluate.setMaximumHeight(32)
        # self.btnLocate.setMaximumHeight(32)
        # self.btnExportResult.setMaximumHeight(32)
        # self.btnOpenData.setMaximumHeight(32)
        # self.btnSaveData.setMaximumHeight(32)
        # self.btnPDTCheck.setMaximumHeight(32)
        #
        # self.btnClose.setMinimumHeight(32)
        # self.btnClose_2.setMinimumHeight(32)
        # self.btnConstruct.setMinimumHeight(32)
        # self.btnEvaluate.setMinimumHeight(32)
        # self.btnLocate.setMinimumHeight(32)
        # self.btnExportResult.setMinimumHeight(32)
        # self.btnOpenData.setMinimumHeight(32)
        # self.btnSaveData.setMinimumHeight(32)
        # self.btnPDTCheck.setMinimumHeight(32)



        self.tab_History = QtGui.QWidget(FlightPlannerBase)
        self.tab_History.setObjectName(_fromUtf8("tab_History"))
        self.horizontalLayout_History = QtGui.QHBoxLayout(self.tab_History)
        self.horizontalLayout_History.setMargin(3)
        self.horizontalLayout_History.setObjectName(_fromUtf8("horizontalLayout_History"))
        self.frmHistory = QtGui.QFrame(self.tab_History)
        # self.frmHistory.setMaximumSize(QtCore.QSize(100, 16777215))
        self.frmHistory.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frmHistory.setFrameShadow(QtGui.QFrame.Raised)
        self.frmHistory.setObjectName(_fromUtf8("frmHistory"))
        self.vlHistory = QtGui.QVBoxLayout(self.frmHistory)
        self.vlHistory.setObjectName(_fromUtf8("vlHistory"))
        self.tblHistory = QtGui.QTableView(self.frmHistory)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Arial"))
        self.tblHistory.setFont(font)
        self.tblHistory.setObjectName(_fromUtf8("tblHistory"))
        self.vlHistory.addWidget(self.tblHistory)

        self.horizontalLayout_History.addWidget(self.frmHistory)

        self.frmHistoryButtons = QtGui.QFrame(self.tab_History)
        self.frmHistoryButtons.setMaximumSize(QtCore.QSize(100, 16777215))
        self.frmHistoryButtons.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frmHistoryButtons.setFrameShadow(QtGui.QFrame.Raised)
        self.frmHistoryButtons.setObjectName(_fromUtf8("frmHistoryButtons"))
        self.vlHistoryBtns = QtGui.QVBoxLayout(self.frmHistoryButtons)
        self.vlHistoryBtns.setObjectName(_fromUtf8("vlHistoryBtns"))


        self.btnHistoryClose = QtGui.QPushButton(self.frmHistoryButtons)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.btnHistoryClose.setFont(font)
        self.btnHistoryClose.setObjectName(_fromUtf8("btnHistoryClose"))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("Resource/btnImage/close.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnHistoryClose.setIcon(icon)
        self.btnHistoryClose.setToolTip(_fromUtf8("Close"))
        self.vlHistoryBtns.addWidget(self.btnHistoryClose)
        spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vlHistoryBtns.addItem(spacerItem)
        self.horizontalLayout_History.addWidget(self.frmHistoryButtons)
        self.tabCtrlGeneral.addTab(self.tab_History, _fromUtf8(""))


        self.retranslateUi(FlightPlannerBase)
        self.tabCtrlGeneral.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(FlightPlannerBase)
    def retranslateUi(self, FlightPlannerBase):
        FlightPlannerBase.setWindowTitle(_translate("FlightPlannerBase", "APV/Baro-VNAV Surfaces", None))
#         self.btnOpenData.setText(_translate("FlightPlannerBase", "Open Data", None))
#         self.btnSaveData.setText(_translate("FlightPlannerBase", "Save Data", None))
#         self.btnConstruct.setText(_translate("FlightPlannerBase", "Construct", None))
#         self.btnPDTCheck.setText(_translate("FlightPlannerBase", "PDT Check", None))
#         self.btnEvaluate.setText(_translate("FlightPlannerBase", "Evaluate", None))
        self.btnUpdateQA.setText(_translate("FlightPlannerBase", "Update QA", None))
#         self.btnExportResult.setText(_translate("FlightPlannerBase", "Export Result", None))
#         self.btnClose.setText(_translate("FlightPlannerBase", "Close", None))
        self.tabCtrlGeneral.setTabText(self.tabCtrlGeneral.indexOf(self.tab_General), _translate("FlightPlannerBase", "General", None))
        self.grbMostCritical.setTitle(_translate("FlightPlannerBase", "The Most Critical Obstacle", None))
        self.label_115.setText(_translate("FlightPlannerBase", "ID:", None))
        self.label_119.setText(_translate("FlightPlannerBase", "X:", None))
        self.label_120.setText(_translate("FlightPlannerBase", "Y:", None))
        self.btnCriticalLocate.setText(_translate("FlightPlannerBase", "...", None))
        self.label_116.setText(_translate("FlightPlannerBase", "Altitude:", None))
        self.label_117.setText(_translate("FlightPlannerBase", " m ", None))
        self.label_118.setText(_translate("FlightPlannerBase", "ft", None))
        self.label_121.setText(_translate("FlightPlannerBase", "Surface:", None))
        self.grbResult_2.setTitle(_translate("FlightPlannerBase", "Results", None))
        self.label_122.setText(_translate("FlightPlannerBase", "Units:", None))
        self.txtOCH.setText(_translate("FlightPlannerBase", "OCH", None))
        self.txtOCA.setText(_translate("FlightPlannerBase", "OCA", None))
        self.grbObstacles.setTitle(_translate("FlightPlannerBase", "Checked Ostacles", None))
        self.label_123.setText(_translate("FlightPlannerBase", "Surface:", None))
#         self.btnLocate.setText(_translate("FlightPlannerBase", "Locate", None))
        self.btnUpdateQA_2.setText(_translate("FlightPlannerBase", "Update QA", None))
#         self.btnClose_2.setText(_translate("FlightPlannerBase", "Close", None))
        self.tabCtrlGeneral.setTabText(self.tabCtrlGeneral.indexOf(self.tab_Results), _translate("FlightPlannerBase", "Results/Checked Obstacles", None))
        self.tabCtrlGeneral.setTabText(self.tabCtrlGeneral.indexOf(self.tab_History), _translate("FlightPlannerBase", "History", None))
