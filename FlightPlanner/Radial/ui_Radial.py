...
#
# Created: Wed Oct 07 09:17:03 2015
...
class Ui_Radial(object):
    def setupUi(self, Form):
        ...
        self.hlPrimaryMOC = QtGui.QHBoxLayout(self.framePrimaryMOC)
        self.hlPrimaryMOC.setSpacing(0)
        self.hlPrimaryMOC.setMargin(0)
        self.hlPrimaryMOC.setObjectName(_fromUtf8("hlPrimaryMOC"))
        self.label_78 = QtGui.QLabel(self.framePrimaryMOC)
        ...
        self.hlPrimaryMOC.addWidget(self.label_78)
        self.frame_APV_13 = QtGui.QFrame(self.framePrimaryMOC)
        ...
        self.txtPrimaryMOC = QtGui.QLineEdit(self.frame_APV_13)
        self.txtPrimaryMOC.setEnabled(True)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.txtPrimaryMOC.setFont(font)
        self.txtPrimaryMOC.setObjectName(_fromUtf8("txtPrimaryMOC"))
        self.horizontalLayout_17.addWidget(self.txtPrimaryMOC)
        self.hlPrimaryMOC.addWidget(self.frame_APV_13)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_78.setText(_translate("Form", "Primary MOC(m):", None))
