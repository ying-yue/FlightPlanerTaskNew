...
from FlightPlanner.NpaOnFix.ui_NpaOnFix import Ui_NpaOnFix
...
#         self.ui.btnPDTCheck.clicked.connect(self.btnPDTCheck_Click)
    ...
    def initParametersPan(self):
        ...
        self.connect(self.parametersPanel.pnlDistFixTolerance, SIGNAL("editingFinished"), self.showMarkDaSoc)
        ...
        self.connect(self.parametersPanel.pnlThrPosition, SIGNAL("positionChanged"), self.showMarkDaSoc)
    ...
    def putDistances(self):
        try:
            ...
            self.parametersPanel.pnlDistOfFafMapt.Value = Distance(MathHelper.calcDistance(point3dFaf, point3dMapt))
            ...
            self.parametersPanel.pnlDistOfSocThr.Value = Distance(MathHelper.calcDistance(self.socPoint3d, point3dThr))#MathHelper.calcDistance(point3dThr, self.daPoint3d))
