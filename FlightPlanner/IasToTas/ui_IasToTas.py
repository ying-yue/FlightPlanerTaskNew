...
#
# Created: Thu Nov 26 09:25:28 2015
...
class Ui_IasToTas(object):
    def setupUi(self, Form):
        ...
        self.vLayoutNonStandardResult.setContentsMargins(0, 0, 0, 0)
        ...
        self.btnNonStd = QtGui.QToolButton(self.frame_NonStandardResult)
        self.btnNonStd.setText(_fromUtf8(""))
        self.btnNonStd.setIcon(icon)
        self.btnNonStd.setObjectName(_fromUtf8("btnNonStd"))
        self.hLayoutRDH_4.addWidget(self.btnNonStd)
    ...
    def retranslateUi(self, Form):
        ...
        self.txtAltitude.setText(_translate("Form", "2500", None))
