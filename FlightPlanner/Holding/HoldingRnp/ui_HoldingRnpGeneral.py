...
#
# Created: Wed Nov 25 16:11:49 2015
...
class Ui_HoldingRnpGeneral(object):
    ...
    def retranslateUi(self, HoldingRnp):
        ...
        self.label_17.setText(_translate("HoldingRnp", "Altitude:", None))
        self.label_2.setText(_translate("HoldingRnp", "m", None))
        self.txtAltitude.setText(_translate("HoldingRnp", "1000", None))
        self.label.setText(_translate("HoldingRnp", "ft", None))
        ...
        self.label_4.setText(_translate("HoldingRnp", "MOC:", None))
        self.txtMoc.setText(_translate("HoldingRnp", "300", None))
        self.label_6.setText(_translate("HoldingRnp", "m", None))
        self.labelMocFt.setText(_translate("HoldingRnp", "ft", None))
