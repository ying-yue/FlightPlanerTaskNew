...
from qgis.gui import QgsCollapsibleGroupBoxBasic, QgsDoubleSpinBox
...
class Ui_QgsComposerShapeWidgetBase(QtGui.QWidget):
    ...
    def retranslateUi(self):
        self.setWindowTitle(_translate("QgsComposerShapeWidgetBase", "Form", None))
