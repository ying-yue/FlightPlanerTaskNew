...
from qgis.gui import QgsSpinBox, QgsCollapsibleGroupBoxBasic, QgsLayerTreeView, QgsDoubleSpinBox, QgsLegendFilterButton, QgsColorButtonV2
...
class Ui_QgsComposerLegendWidgetBase(QtGui.QWidget):
    def __init__(self, parent):
        ...
        self.setTabOrder(self.mFilterByMapToolButton, self.mExpressionFilterButton)
        self.setTabOrder(self.mExpressionFilterButton, self.mFilterLegendByAtlasCheckBox)
        self.setTabOrder(self.mFilterLegendByAtlasCheckBox, self.mFontsColGroupBox)
        ...
        self.setTabOrder(self.mColumnCountSpinBox, self.mEqualColumnWidthCheckBox)
        self.setTabOrder(self.mEqualColumnWidthCheckBox, self.mSplitLayerCheckBox)
        ...
        self.setTabOrder(self.mRasterBorderGroupBox, self.mRasterBorderColorButton)
        self.setTabOrder(self.mRasterBorderColorButton, self.mRasterBorderWidthSpinBox)
        self.setTabOrder(self.mRasterBorderWidthSpinBox, self.mSymbolsColGroupBox_2)
        self.setTabOrder(self.mSymbolsColGroupBox_2, self.mWmsLegendWidthSpinBox)
        self.setTabOrder(self.mWmsLegendWidthSpinBox, self.mWmsLegendHeightSpinBox)
        self.setTabOrder(self.mWmsLegendHeightSpinBox, self.mSpacingColGroupBox)
        self.setTabOrder(self.mSpacingColGroupBox, self.mTitleSpaceBottomSpinBox)
        self.setTabOrder(self.mTitleSpaceBottomSpinBox, self.mGroupSpaceSpinBox)
    ...
    def retranslateUi(self):
        self.setWindowTitle(_translate("QgsComposerLegendWidgetBase", "Legend Options", None))
