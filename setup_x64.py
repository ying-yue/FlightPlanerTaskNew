...
options = {
   "py2exe": {
       ...
       "dll_excludes": ['api-ms-win-security-activedirectoryclient-l1-1-0.dll','api-ms-win-core-heap-l1-2-0.dll','api-ms-win-security-base-l1-2-0.dll','api-ms-win-core-libraryloader-l1-2-0.dll','api-ms-win-core-delayload-l1-1-1.dll','api-ms-win-core-heap-l2-1-0.dll', 'api-ms-win-core-localization-obsolete-l1-3-0.dll', 'api-ms-win-core-rtlsupport-l1-2-0.dll', 'libgdk_pixbuf-2.0-0.dll', 'libgobject-2.0-0.dll', 'libgdk-win32-2.0-0.dll', 'phonon4.dll', 'QtScriptTools4.dll', 'tcl84.dll', 'tk84.dll' ],
       "packages": ["qgis", "PyQt4"],
       "dist_dir": "dist",
   }
}
